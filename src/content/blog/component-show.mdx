...
提示组件，显示带下划线的文本，支持鼠标悬停显示提示框和点击复制功能。

### 基础用法（带提示框）

我是一条小提示，<Tip text="我没有图标" tip="提示的内容是提示" />，鼠标悬停查看提示。

### 带图标和提示

<Tip text="带图标的提示" icon tip="或许也可以没有内容" />

### 复制功能

<Tip copy>+v 点击就能复制，太方便了！</Tip>

---

## VideoEmbed

视频嵌入组件，支持多种视频平台（原始视频、Bilibili 等），自动适配不同平台的宽高比。

### 原始视频

支持自定义海报图，适合展示本地或直链视频。
